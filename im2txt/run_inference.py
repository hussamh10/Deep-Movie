...
def main(_):
    ...
    silentFramesFile = "im2txt/silenceFrames.txt"
    actionRecognitionFile = "im2txt/action.txt"
    portionFile = "im2txt/portion.mp4"
    portionNPYFile = "im2txt/portion.npy"
    mainDirectory = "im2txt/"
