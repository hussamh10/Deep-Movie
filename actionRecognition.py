...
# custom function to find frames
_SAMPLE_VIDEO_FRAMES = int(argv[1])

_IMAGE_SIZE = 224
_NUM_CLASSES = 400

_SAMPLE_PATHS = {
    'flow': '/Users/fahadzafar/GoogleDrive/University/FYP/im2txt/portion.npy',
}
...
def main(unused_argv):
  ...
  with tf.Session() as sess:
    ...
    for index in sorted_indices[:1]:
      file.write(str(out_predictions[index]) + " " + str(kinetics_classes[index]) + "\n")
